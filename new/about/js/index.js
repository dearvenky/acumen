(function() {
  ...
  MESSAGES.push({
    delay: 0,
    text: "The pace of progress in the field of Science & Technology in this millennium has overshadowed the speed of Technological changes in the past decades."
  });

  MESSAGES.push({
    delay: 1200,
    text: "Technical Symposiums like Acumen are an effort to catch up with the pace of technological innovation."
  });

  MESSAGES.push({
    delay: 2200,
    text: "The event seeks to achieve communication of innovative ideas that promote the cause of the technological advantage among the students, and also  keep them abreast with the latest advances in their respective fields."
  });

  MESSAGES.push({
    delay: 3600,
    text: " It also opens a window to the participants to interact with people from different backgrounds and upgrade their knowledge."
  });

  MESSAGES.push({
    delay: 5200,
    text: "The theme 'YOUTH-TECHNOLOGY-FUTURE' asserts the fact that the future of technology lies in the hands of the youth."
  });
