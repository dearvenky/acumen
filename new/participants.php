...
<body>
	...
	<table class="data-table">
		...
		<?php
		$no=0;
		$db = mysqli_connect('localhost', 'acumenec_robo','18acumen20', 'acumenec_acumen'); 
		$sql="SELECT first_name,branch,gender,package,roll,mobile,email,college FROM members";
