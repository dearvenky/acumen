...
<head>
  <meta charset="UTF-8">
  <title>Login(Acumen ECE 2k18)</title>
    ...
    <div id="fade-box">
      <input type="text"  name="email" id="name" placeholder="Username" required>
        <input type="password"  name="password"  placeholder="password" required>
          ...
          <button  id="login" type="submit" name="login_member" >Log In</button> 
        </div>
      </form>
      <div class="hexagons">
        <span>&#x2B22;</span>
